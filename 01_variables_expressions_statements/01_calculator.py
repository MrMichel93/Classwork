"""
Mini-Program 1: Simple Calculator
Topic: Variables, Expressions and Statements

Learning Objectives:
- Learn how to create and use variables
- Understand different data types (int, float, string)
- Practice arithmetic operations and expressions
- Use the print() function to display results

Instructions:
Complete the calculator program below by filling in the missing code.
