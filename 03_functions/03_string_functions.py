"""
Mini-Program 3: String Manipulation Functions
Topic: Functions

Learning Objectives:
- Create functions that work with strings
- Return string values from functions
- Use string methods inside functions
- Practice parameter passing with strings
